...
app.use('/user', express.static('user')); // Serve static files from "wst-website" folder
        ...
        if (results.length > 0) {
            ...
            bcrypt.compare(password, user.password, (err, isMatch) => {
                ...
                if (isMatch) {
                    ...
                    res.json({ success: true, message: 'Login successful', redirectUrl: '/user/index.html' });
                } else {
                    // Invalid credentials
    ...
    db.query(query, [admin_name], (err, results) => {
        ...
        if (results.length > 0) {
            ...
            if (admin_password === storedPassword) {
                ...
                res.json({ success: true, redirectUrl: '/admin/admin.html' });
            } else {
